...
const ALL_PRODUCTS = [
  ...
  { _id: '65b100000000000000000003', title: 'Amber Mystique', category: { name: 'Perfume' }, price: 11200, oldPrice: 13500, discount: 17, rating: 4.6, reviewCount: 156, images: ['https://picsum.photos/seed/perf3/600/700', 'https://picsum.photos/seed/perf3b/600/700'], stock: 30, description: 'Warm amber with vanilla and sandalwood.', specifications: [{ key: 'Volume', value: '100ml' }, { key: 'Top Notes', value: 'Amber, Vanilla' }, { key: 'Heart Notes', value: 'Sandalwood, Musk' }] },
  { _id: '65b100000000000000000005', title: 'Midnight Oud', category: { name: 'Perfume' }, price: 14500, rating: 4.9, reviewCount: 312, images: ['https://picsum.photos/seed/perf5/600/700', 'https://picsum.photos/seed/perf5b/600/700'], stock: 20, bestSeller: true, description: 'Intense oud with smoky leather and incense.' },
];
